...
//            // Image captured successfully, retrieve the image URI from the data intent
//            val imageUri = data?.data
//
//            if (imageUri != null) {
//                // Use the imageUri to navigate to the ProfileFragment and pass the image URI as an argument
//                val bundle = Bundle()
